...
resource eventGridTopic 'Microsoft.EventGrid/systemTopics@2025-07-15-preview' = {
  location: location
  name: topicName
  identity: {
    type: 'SystemAssigned'
...
@batchSize(1)
resource eventGridSubscription 'Microsoft.EventGrid/systemTopics/eventSubscriptions@2025-07-15-preview' = [for container in containers: {
  name: container
